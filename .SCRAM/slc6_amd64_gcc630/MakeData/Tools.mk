...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/blackhat/0.9.9-omkpbe2/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/boost/1.63.0-omkpbe2/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/boost/1.63.0-omkpbe2/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/boost/1.63.0-omkpbe2/include
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/cascade/2.2.04-omkpbe3/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/cgal/4.2-omkpbe2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/charybdis/1.003-omkpbe3/include
...
ALL_TOOLS      += clhep
clhep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/clhep/2.4.0.0-omkpbe3/include
clhep_EX_LIB := CLHEP
clhep_EX_USE := root_cxxdefaults
clhep_EX_FLAGS_CXXFLAGS  := -Wno-error=unused-variable

ALL_TOOLS      += clhepheader
clhepheader_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/clhep/2.4.0.0-omkpbe3/include
clhepheader_EX_USE := root_cxxdefaults
clhepheader_EX_FLAGS_CXXFLAGS  := -Wno-error=unused-variable

ALL_TOOLS      += cmsswdata
cmsswdata_EX_FLAGS_CMSSW_DATA_PACKAGE  := CalibCalorimetry/CaloMiscalibTools=V01-00-00 CalibCalorimetry/EcalTrivialCondModules=V00-01-00 CalibTracker/SiPixelESProducers=V02-00-00 CalibTracker/SiStripDCS=V01-00-00 Calibration/Tools=V01-00-00 CondFormats/JetMETObjects=V01-00-03 Configuration/Generator=V01-00-01 DQM/PhysicsHWW=V01-00-00 DQM/SiStripMonitorClient=V01-00-00 DataFormats/PatCandidates=V01-00-01 DetectorDescription/Schema=V02-02-01 EgammaAnalysis/ElectronTools=V00-01-00 EventFilter/L1TRawToDigi=V01-00-00 FastSimulation/MaterialEffects=V05-00-00 FastSimulation/TrackingRecHitProducer=V01-00-02 Fireworks/Geometry=V07-05-04 GeneratorInterface/EvtGenInterface=V02-00-09 GeneratorInterface/ReggeGribovPartonMCInterface=V00-00-02 HLTrigger/JetMET=V01-00-00 L1Trigger/L1TCalorimeter=V01-00-22 L1Trigger/L1TGlobal=V00-00-07 L1Trigger/L1THGCal=V01-00-05 L1Trigger/L1TMuon=V01-01-01 L1Trigger/RPCTrigger=V00-15-00 MagneticField/Interpolation=V01-00-02 PhysicsTools/NanoAOD=V01-00-01 RecoBTag/CTagging=V01-00-03 RecoBTag/Combined=V01-00-08 RecoBTag/SecondaryVertex=V02-00-04 RecoBTag/SoftLepton=V01-00-01 RecoEgamma/ElectronIdentification=V01-00-08 RecoEgamma/PhotonIdentification=V01-00-05 RecoHI/HiJetAlgos=V01-00-01 RecoJets/JetProducers=V05-10-20 RecoLocalCalo/EcalDeadChannelRecoveryAlgos=V01-00-00 RecoMET/METPUSubtraction=V01-00-03 RecoMuon/MuonIdentification=V01-12-03 RecoParticleFlow/PFBlockProducer=V02-04-02 RecoParticleFlow/PFProducer=V15-00-00 RecoParticleFlow/PFTracking=V13-01-00 RecoTracker/FinalTrackSelectors=V01-00-01 SLHCUpgradeSimulations/Geometry=V01-00-08 SimG4CMS/Calo=V03-01-00 SimG4CMS/Forward=V02-03-18 SimTracker/SiStripDigitizer=V01-00-00 SimTransport/HectorProducer=V01-00-01 Validation/Geometry=V00-07-00

ALL_TOOLS      += coral
ALL_SCRAM_PROJECTS += coral
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/coral/CORAL_2_3_21-omkpbe4/include/LCG
...
cuda-api-wrappers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/cuda-api-wrappers/20180125-omkpbe3/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/cuda/9.1.85-omkpbe3/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/cuda/9.1.85-omkpbe3/lib64/stubs
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/davix/0.6.7/include/davix
davix_EX_LIB := davix
...
ALL_TOOLS      += dd4hep
dd4hep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/dd4hep/v01-06x/include
dd4hep_EX_LIB := DDAlign DDCore DDCond DDParsers
dd4hep_EX_USE := root_cxxdefaults root boost xerces-c clhep

ALL_TOOLS      += dire
dire_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/dire/2.001-omkpbe2/include
dire_EX_LIB := dire
...
ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/eigen/1ae2849542a7892089f81f2ee460b510cdb0a16d/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/evtgen/1.6.0-omkpbe3/include
...
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/fastjet-contrib/1.033-omkpbe/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/fastjet-contrib/1.033-omkpbe/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/fastjet/3.3.0-omkpbe/include
...
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/frontier_client/2.8.20-omkpbe2/include
frontier_client_EX_LIB := frontier_client
frontier_client_EX_USE := root_cxxdefaults zlib openssl expat python

ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/gbl/V02-01-03-omkpbe3/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/geant4/10.04-omkpbe3/include/Geant4
...
gosamcontrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/gosamcontrib/2.0-20150803-omkpbe/include
...
ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/hector/1.3.4_patch1-omkpbe4/include
...
ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/heppdt/3.03.00-mmelna/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/herwig/6.521-omkpbe3/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/herwigpp/7.1.2-omkpbe4/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/jimmy/4.2-omkpbe3/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/ktjet/1.06-omkpbe3/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lhapdf/6.2.1-omkpbe3/include
...
ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/libxslt/1.1.28-omkpbe2/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/llvm/5.0.0-omkpbe2/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/lwtnn/2.4-omkpbe4/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/mctester/1.25.0a-omkpbe4/include
...
oracleocci_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cms_oracleocci_abi_hack/20180210/include
...
ALL_TOOLS      += pngwriter
pngwriter_EX_INCLUDE := /afs/cern.ch/user/e/ebarraza/workspace/soft/usr/include
pngwriter_EX_LIB := PNGwriter
pngwriter_EX_FLAGS_CXXFLAGS  := -DNO_FREETYPE
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/protobuf/3.4.0-omkpbe/include
...
py2-flawfinder_EX_USE := py2-pippkgs
...
py2-numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/py2-numpy/1.14.1-omkpbe2/c-api/core/include
...
ALL_TOOLS      += py2-oamap
py2-oamap_EX_USE := py2-pippkgs_depscipy
...
py2-uproot_EX_USE := py2-pippkgs_depscipy
...
ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/pythia8/230-omkpbe3/include
pythia8_EX_LIB := pythia8
pythia8_EX_USE := root_cxxdefaults cxxcompiler hepmc lhapdf

ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/python/2.7.11-omkpbe2/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += python3
python3_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/python3/3.6.4-omkpbe/include/python3.6m
...
ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/rivet/2.5.4-omkpbe4/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/lcg/root/6.10.09-omkpbe4/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/lcg/root/6.10.09-omkpbe4/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/lcg/root/6.10.09-omkpbe4/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/cern.ch/work/e/ebarraza/CMSSW_builds/CMSSW_10_1_2/src /afs/cern.ch/work/e/ebarraza/CMSSW_builds/CMSSW_10_1_2/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_10_1_2/src /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_10_1_2/include/LCG
self_EX_LIBDIR := /afs/cern.ch/work/e/ebarraza/CMSSW_builds/CMSSW_10_1_2/lib/slc6_amd64_gcc630 /afs/cern.ch/work/e/ebarraza/CMSSW_builds/CMSSW_10_1_2/external/slc6_amd64_gcc630/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_10_1_2/lib/slc6_amd64_gcc630 /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/cmssw/CMSSW_10_1_2/external/slc6_amd64_gcc630/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/sherpa/2.2.4-omkpbe4/include/SHERPA-MC
...
ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/starlight/r193-omkpbe3/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tauolapp/1.1.5-omkpbe3/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tbb/2018_U1/include
tbb_EX_LIB := tbb
...
tensorflow-c_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tensorflow-c/1.5.0-omkpbe/include
tensorflow-c_EX_LIB := tensorflow

ALL_TOOLS      += tensorflow-cc
tensorflow-cc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tensorflow-cc/1.5.0-omkpbe/tensorflow_cc/include
tensorflow-cc_EX_LIB := tensorflow_cc tensorflow_framework
tensorflow-cc_EX_USE := eigen protobuf

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/thepeg/2.1.1-omkpbe4/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tinyxml/2.5.3-omkpbe2/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/tkonlinesw/4.2.0-1_gcc7-omkpbe/include
...
ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/utm/utm_0.6.5-omkpbe2/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/valgrind/3.13.0-omkpbe/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/cms/vdt/0.4.0/include
...
vecgeom_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/vecgeom/v00.05.00-omkpbe/include
...
ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/vincia/2.2.01-omkpbe3/include
...
ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/xrootd/4.6.1-omkpbe4/include/xrootd /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/xrootd/4.6.1-omkpbe4/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xtensor
xtensor_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/xtensor/0.15.4/include
xtensor_EX_USE := xtl

ALL_TOOLS      += xtl
xtl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/xtl/0.4.1/include
...
ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/yaml-cpp/0.5.1-omkpbe2/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc630/external/yoda/1.6.7-omkpbe4/include
yoda_EX_LIB := YODA
